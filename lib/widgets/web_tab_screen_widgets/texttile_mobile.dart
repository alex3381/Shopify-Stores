...
class TextTile_Mobile extends StatefulWidget {
  const TextTile_Mobile({
    Key? key,
  }) : super(key: key);
  @override
  State<TextTile_Mobile> createState() => _TextTile_MobileState();
}

class _TextTile_MobileState extends State<TextTile_Mobile> {
